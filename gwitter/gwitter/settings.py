"""
Django settings for gwitter project.
...
SECRET_KEY = '$m5j)i(!(m)#1#9o*$#yr*t=snoom_1&hjb&sgmjbnuqji$jlk'
...
MIDDLEWARE = [
    ...
    'token_auth.middleware.CorsMiddleware',
...
WSGI_APPLICATION = 'gwitter.wsgi.application'
